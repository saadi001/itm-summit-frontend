...
const Registration = () => {
     ...
     return (
          <div className='pb-10'>
               <section class="p-4 sm:p-6 md:p-10 mt-6 mx-auto bg-white rounded-md shadow-md border">
                    ...
                    <form onSubmit={handleSubmit(handleRegisterForm)}>
                         <div class="grid grid-cols-1 gap-6 my-6 sm:grid-cols-2">
                              <div>
                                   ...
                                   <input {...register('name', {required: "This field is required."})} id="username" type="text" class="block w-full px-4 py-[10px] mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                              ...
                              <div>
                                   ...
                                   <input {...register('id', {required: "This field is required."})} id="id" type="text" class="block w-full px-4 py-[10px] mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                              ...
                              <div>
                                   ...
                                   <input {...register('email', {required: "This field is required."})} id="email" type="email" class="block w-full px-4 py-[10px] mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                              ...
                              <div>
                                   ...
                                   <input  id="semester" type="text" class="block w-full px-4 py-[10px] mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                              </div>

                              <div>
                                   <label class="text-gray-700 dark:text-gray-200" for="phoneNumber">Phone Number(Whatsapp)</label>
                                   <input {...register('phone', {required: "This field is required."})} id="phoneNumber" type="number" class="block w-full px-4 py-[10px] mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                              ...
                              <div>
                                   ...
                                   <input {...register('image', {required: "This field is required."})} type="file" class="block w-full px-3 py-[10px] mt-2 text-sm text-gray-600 bg-white border border-gray-200 rounded-lg file:bg-gray-200 file:text-gray-700 file:text-sm file:px-4 file:py-1 file:border-none file:rounded-full dark:file:bg-gray-800 dark:file:text-gray-200 dark:text-gray-300 placeholder-gray-400/70 dark:placeholder-gray-500 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:focus:border-blue-300" />
                              ...
                              <div>
                                   ...
                                   <input {...register('transactionID', {required: "This field is required."})} id="transaction" type="text" class="block w-full px-4 py-[10px] mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                         ...
                         <div class="flex justify-end mt-6">
                              <button disabled={!checkbox} class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-pink-600 disabled:bg-pink-300 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-500">Register</button>
                         </div>
                    </form>
               </section>
