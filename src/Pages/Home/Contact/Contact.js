                    ...
                    <div className="grid gap-8  mx-auto lg:grid-cols-3">
                         ...
                         <div className="grid grid-cols-1 gap-12 lg:col-span-2 sm:grid-cols-2 ">
                              <div className="p-4 rounded-lg bg-blue-100 md:p-6 ">
                                   ...
                                   <a href='mailto:sheikhsadi1620@gmail.com' className="mt-2 text-sm text-blue-500 ">itmsummit@support.com</a>
                              </div>
                              ...
                              <div className="p-4 rounded-lg bg-blue-100 md:p-6 ">
                                   ...
                                   <p className="mt-2 text-sm text-blue-500 ">+8801757210124</p>
                              </div>
                              ...
                              <div className="p-4 rounded-lg bg-blue-100 md:p-6 ">
                                   ...
                                   <p className="mt-2 text-sm text-blue-500 ">601(B), 6th floor, AB4 Daffodil International University.</p>
                              </div>
