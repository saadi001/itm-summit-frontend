          ...
          <div id='about' className='mt-14'>
               <div className=''>
                    ...
                    <div className='font-serif'>
                         <div className='text-base'>The ITM Summit 2023 is a one-day event hosted by the Information Technology & Management (ITM) department of Daffodil International University. The summit will be held on March 04, 2023 and is aimed at providing students and professionals with a platform to exchange ideas, share knowledge, and network with each other.</div>
                         ...
                         <div className='text-base mt-4'>We are honored to have the opportunity to host such a visionary leader and education entrepreneur, Ayman sadiq, as the keynote speaker at our summit. His wealth of knowledge and experience in the field of education and technology will be of immense value to the students and attendees of our summit.</div>
